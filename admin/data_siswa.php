...
<body>
  ...
  <div class="container pb-5 mt-5">
    ...
    <!-- Start Akun -->
      ...
      <a href="tambah_siswa.php" class="btn btn-primary btn-sm mb-3"><i class="fa fa-plus me-2"></i>Tambah</a>
      <a href="printsiswa.php" class="btn btn-warning btn-sm mb-3"><i class="bi bi-printer"></i>Print</a>
      ...
      <table id="buku" class="table col-12 table-bordered display border mt-6 table-hover table-sm ">
          ...
          <tr>
            ...
            <td><?php echo $row["nip_wk"] ?></td>
            <td><?php echo $row["nama_wk"] ?></td>
            <td>
                <a class="btn btn-sm btn-primary" href="editsiswa.php?nis=<?=$row["nis"];?>"><i class="fa fa-pencil"></i></a>
                <a class="btn btn-sm btn-danger" href="hapussiswa.php?nis=<?=$row["nis"];?>"><i class="fa fa-trash"></i></a>
            </td>
        </tr>
        <?php $i++ ?>
        <?php endforeach; ?>
