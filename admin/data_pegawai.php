...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <title>Halaman Admin Pegawai</title>
</head>
<body>
  <!-- Start Navbar -->
  ...
  <div class="container pb-5 mt-5">
    ...
    <!-- Start Akun -->
      ...
      <a href="tambah_guru.php" class="btn btn-primary btn-sm mb-3"><i class="fa fa-plus me-2"></i>Tambah</a>
      <a href="printguru.php" class="btn btn-warning btn-sm mb-3"><i class="bi bi-printer"></i>Print</a>
      ...
      <table id="buku" class="table col-12 table-bordered display border mt-6 table-hover table-sm ">
          ...
          <tr>
            ...
            <td>
                <a class="btn btn-sm btn-primary" href="editpegawai.php?nip=<?=$row["nip"];?>"><i class="fa fa-pencil"></i></a>
                <a class="btn btn-sm btn-danger" href="hapuspegawai.php?nip=<?=$row["nip"];?>"><i class="fa fa-trash"></i></a>
            </td>
        </tr>
        <?php $i++ ?>
        <?php endforeach; ?>
