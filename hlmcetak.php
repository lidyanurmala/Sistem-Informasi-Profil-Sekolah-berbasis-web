...
<body>
  ...
  <div class="container pb-5 mt-5">
    ...
    <ul class="nav nav-tabs mt-3">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="hlmcetak.php">Cetak Kartu</a>
      </li>
      <li class="nav-item">
  ...
  <div class="col-md-6">
      ...
      <table id="buku" class="table col-12 table-bordered display border mt-6 table-hover table-sm ">
          ...
          <tr>
            ...
            <td>
            <a href="print.php?nisn=<?=$row["nisn"];?>" class="btn btn-warning btn-sm mb-3"><i class="bi bi-printer"></i>Print</a>
            </td>
        </tr>
        <?php $i++ ?>
        <?php endforeach; ?>
